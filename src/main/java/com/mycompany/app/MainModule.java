...
//
//    public MainModule(SqlParserOptions sqlParserOptions)
//    {
...
//    }
    ...
    public void configure(Binder binder)
    {
        ...
        bindFailureDetector(binder, true);
        ...
        discoveryBinder(binder).bindHttpAnnouncement("presto")
                ...
                .addProperty("coordinator", String.valueOf(true));
...
//        // node manager
//        discoveryBinder(binder).bindSelector("presto");
//        binder.bind(com.facebook.presto.metadata.DiscoveryNodeManager.class).in(Scopes.SINGLETON);
//        binder.bind(InternalNodeManager.class).to(com.facebook.presto.metadata.DiscoveryNodeManager.class).in(Scopes.SINGLETON);
//        newExporter(binder).export(com.facebook.presto.metadata.DiscoveryNodeManager.class).withGeneratedName();
//        httpClientBinder(binder).bindHttpClient("node-manager", ForNodeManager.class)
//                .withTracing()
//                .withConfigDefaults(config -> {
//                    config.setIdleTimeout(new Duration(30, SECONDS));
...
//
//        // cleanup
//        binder.bind(ServerMainModule.ExecutorCleanup.class).in(Scopes.SINGLETON);
//    }
